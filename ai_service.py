...
# Struttura di sicurezza di fallback rigida in caso di errori di connessione o parsing
...
def evaluate_trade_with_gemini(trade_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        # Configurazione dell'SDK con la chiave dalle variabili d'ambiente
        ...
        # Inizializzazione del modello con la system instruction
        ...
        # 2. Configurazione con response_mime_type="application/json"
        generation_config = genai.types.GenerationConfig(
            response_mime_type="application/json",
            temperature=0.1
        )

        # Invocazione della generazione dei contenuti
        ...
        # Pulizia preventiva per garantire il parsing JSON pulito
        ...
        # Controllo che 'action' sia valida, altrimenti fallback rigido su HOLD
