...
const regex = /\{\/\* Feedback Form \*\/\}\s*<div className="bg-gray-50 p-6 rounded-2xl shadow-sm border border-gray-200 mt-6">\s*<h2 className="text-lg font-medium text-gray-900 mb-3 flex items-center justify-between">\s*<div className="flex items-center gap-2">\s*<MessageSquare className="w-5 h-5 text-gray-500" \/>\s*Loop di Correzione \(Invia Regole al Bot\)\s*<\/div>\s*<\/h2>\s*<form/;
